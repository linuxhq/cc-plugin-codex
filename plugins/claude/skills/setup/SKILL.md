...
Report the result. Setup does not install software or start a paid review. If
Claude is missing, provide the official installation guidance at
`https://code.claude.com/docs/en/setup`. If authentication is missing, tell the
user to run `claude auth login` in their terminal.
...
gate; unavailable Claude produces setup guidance. Reviews consume Claude usage
